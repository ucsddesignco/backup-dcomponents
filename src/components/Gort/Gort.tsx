...
const gortImg =
  "https://ih1.redbubble.net/image.3919572071.7167/pp,504x498-pad,600x600,f8f8f8.jpg";
const gortVid =
  "https://www.youtube.com/embed/lvwZQTB4iv4?rel=0?version=3&autoplay=1&controls=0&showinfo=0&loop=1";
...
function Gort({ autoplay = true }: GortProps) {
  ...
  const keyPressHandler: KeyboardEventHandler = (
